...
curl "https://raw.githubusercontent.com/robertmaury/workshop-control-repo/production/workshop_key.enc" -L -o ~/workshop_key.enc
...
git remote add origin git@github.com:robertmaury/workshop-control-repo
